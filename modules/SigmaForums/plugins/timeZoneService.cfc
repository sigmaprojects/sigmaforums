<cfcomponent displayname="timezone" hint="various timezone functions not included in mx: version 2.1 jul-2005 Paul Hastings (paul@sustainbleGIS.com)" extends="coldbox.system.plugin" output="false">
<!---
...
revisions:
			...
			4-apr-1011 converted to ColdBox plugin
 ...
 --->
	...
	<cffunction name="init" access="public" returntype="any" hint="Constructor.">
		...
		<cfscript>
			...
			setpluginName("timeZoneService");
			setpluginVersion("1.7");
			setpluginDescription("Time Zone Service");
		</cfscript>
	...
	<cffunction name="castToServer" output="false" access="public" returntype="date"
		...
		<cfargument name="thisDate" required="yes" type="date">
		<cfargument name="tz" required="false" default="#variables.mytz#">
		<cfreturn dateConvert("utc2LOCAL_RET",castToUTC(arguments.thisDate, arguments.tz))>
	</cffunction>
	...
	<cffunction name="castFromServer" output="false" access="public" returntype="date"
		...
		<cfargument name="thisDate" required="yes" type="date">
		<cfargument name="tz" required="false" default="#variables.mytz#">
		<cfreturn castFromUTC(dateConvert("LOCAL_RET2UTC",arguments.thisDate),arguments.tz)>
	</cffunction>
